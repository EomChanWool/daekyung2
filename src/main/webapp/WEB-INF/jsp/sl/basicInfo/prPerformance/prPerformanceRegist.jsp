	                                ...
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											...
											<tr>
												...
												<th>납기일</th>
												<td><input type="date" class="form-control" name="relNabgi" id="relNabgi" /></td>
											</tr>
											<tr>
												<th>수량</th>
											...
											<tr>
												<th>금액</th>
												<td><input type="text" class="form-control" name="relPrice" id="relPrice" /></td>
												<th>품명</th>
											...
											<tr>
												<th>성적서일자</th>
												<td><input type="date" class="form-control" name="relReport" id="relReport" /></td>
												<th>완료일자</th>
												<td><input type="date" class="form-control" name="relCompletion" id="relCompletion" /></td>
											</tr>
											<tr>
												<th>담당자</th>
												<td><input type="text" class="form-control" name="relPerson" id="relPerson" /></td>
												<th>출고일</th>
												<td><input type="date" class="form-control" name="relClgo" id="relClgo" /></td>
											</tr>
											<tr>
												<th>비고</th>
